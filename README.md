# genpark-lightweight-local-model-daemon-lifecycle-manager-skill
...
> **GenPark AI Agent Skill** -- Lightweight local model daemon lifecycle manager & hot-swapper (Ollama style)
